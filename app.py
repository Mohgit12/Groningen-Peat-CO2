...
def main():
    ...
    gdf = gpd.read_file(r"dashboard_Data.gpkg", layer="main")
    ...
    wmu_gdf = gpd.read_file(r"dashboard_Data.gpkg", layer="waterManagementUnits")
    wmu_gdf = ensure_wgs84(wmu_gdf)
    wmu_geojson = json.loads(wmu_gdf.to_json())

    scenarios_df = pd.read_csv(r"parcel_co2_scenarios.csv", sep=";", decimal=",")
